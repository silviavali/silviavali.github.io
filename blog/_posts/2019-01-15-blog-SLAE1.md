...
This blog post covers the 1/7 task of the [SLAE certificate exam](https://www.pentesteracademy.com/course?id=7) of creating a 64-bit bindshell which has a check if the correct passphrase is entered upon establishing the connection.<br>
<b>Student ID</b>: SLAE64 - 1594

<b>Task - </b> Create a bind TCP shellcode which:

* binds to a port
* needs a "passcode"
* if passcode is entered correctly then executes shell
* remove all 0x00 bytes from the bind TCP shellcode

...
This blog post covers the 2/7 task of the [SLAE certificate exam](https://www.pentesteracademy.com/course?id=7) which requires a 64-bit reverse shellcode. To establish a connection user is asked to submit the correct passphrase.<br>
<b>Student ID</b>: SLAE64 - 1594

<b>Task - </b> Create a reverse TCP shellcode which:
